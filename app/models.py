...
from sqlalchemy import Boolean, Column, Date, DateTime, ForeignKey, Integer, JSON, String, UniqueConstraint, func
...
class DailyQuestion(Base):
    ...
    __table_args__ = (UniqueConstraint("question_date", "sequence", name="uq_daily_question"),)
...
class UserAnswer(Base):
    ...
    question_id: int = Column(Integer, ForeignKey("daily_questions.id", ondelete="CASCADE"), nullable=False, index=True)
